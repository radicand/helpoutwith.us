          ...
          <DialogContent>
            ...
            <DialogContentText>
              ...
              <p>
                ...
                {SITE_TITLE} are asked to provide additional information,
                including as necessary the personal and financial information
                required to process those transactions. In each case,{' '}
                {SITE_TITLE} collects such information only insofar as is
                necessary or appropriate to fulfill the purpose of the visitor's
                interaction with {SITE_TITLE}. {SITE_TITLE} does not disclose
              ...
              <p>
                ...
                {SITE_TITLE} does not disclose personally-identifying
              ...
              <p>
                {SITE_TITLE} discloses potentially personally-identifying and
                ...
                at large. If you are a registered user of an {SITE_TITLE}{' '}
                website and have supplied your email address, {SITE_TITLE} may
                ...
                going on with {SITE_TITLE} and our products. If you send us a
                ...
                other users. {SITE_TITLE} takes all measures reasonably
              ...
              <p>
                ...
                the website each time the visitor returns. {SITE_TITLE} uses
                cookies to help {SITE_TITLE} identify and track visitors, their
              ...
              <p>
                ...
                Policy covers the use of cookies by {SITE_TITLE} and does not
